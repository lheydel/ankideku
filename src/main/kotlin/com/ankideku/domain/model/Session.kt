...
sealed class SessionState(val dbString: String) {
    @Serializable data object Pending : SessionState("pending")
    @Serializable data object Running : SessionState("running")
    @Serializable data object Completed : SessionState("completed")
    @Serializable data object Incomplete : SessionState("incomplete")  // App closed mid-processing
    @Serializable data class Failed(val message: String, val exitCode: Int? = null) : SessionState("failed")
    @Serializable data object Cancelled : SessionState("cancelled")
